                                    ...
                                    <form method="POST" action="/admin/settings/seo">
                                     @csrf
                                        ...
                                        <div class="form-group">
                                            <label for="inputdescription">Edit SEO Description</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputkeywords" type="text" class="form-control form-control-lg @error('keywords') is-invalid @enderror" name="keywords" value="{{ old('keywords', $seo_setting->keywords) }}" required autocomplete="keywords" autofocus placeholder="Add site logo">
